...
```bash
mkdir -p /tmp/config/openstack/2012-08-10
mkdir -p /tmp/config/openstack/content
touch /tmp/config/openstack/2012-08-10/meta_data.json
touch /tmp/config/openstack/2012-08-10/user_data
touch /tmp/config/openstack/content/0000
```
